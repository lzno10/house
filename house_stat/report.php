...
<h4>欢迎使用地图统计报表平台。</h4>
   <div class="progress progress-striped">
      <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 20%"><span class="sr-only">20% Complete (danger)</span></div>
   </div>
【注】: Sorry，本平台不接受外部统计需求，纯业余时间开发。
</div>
